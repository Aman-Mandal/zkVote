const chains = ['Ethereum', 'Polygon (POS)', 'Polygon ZkEVM'];
      ...
      <div className='bg-[#181818] p-8 rounded-t-xl flex'>
        <div className='flex-[0.75] '>
          <div className='flex items-center gap-4'>
            ...
            />
            <p className='font-semibold text-2xl text-[#f2f2f2]'>
              Arbitrum DAO
            </p>
          </div>

          <p className='text-[#828282] mt-4'>
            Aave DAO is a community-driven governance model that enables token
            holders to propose and vote on changes to the Aave protocol on
            Ethereum.
          </p>
        </div>
